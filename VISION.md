...
- proposing section-aware EQ, compression, sidechain, transient, and automation changes;
...
- measuring LUFS, true peak, crest factor, spectral balance, stereo width, and other evidence before and after changes;
...
6. Render, meter, or otherwise capture A/B evidence.
7. Let the artist judge the musical result.
