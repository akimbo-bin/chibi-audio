...
BOUNDED_WRITE_METHODS = frozenset({"parameter_set", "track_mixer_parameter_set", "track_set", "track_presentation_batch_set", "device_parameter_set", "device_parameter_ref_set", "device_enabled_set"})
