...
from .sidechain_read import SIDECHAIN_READ_METHODS, install_sidechain_read
...
install_sidechain_read(AbletonLiveMCP)

_bridge.MODEL_READ_METHODS = _bridge.MODEL_READ_METHODS + LOCATOR_READ_METHODS + SIDECHAIN_READ_METHODS
